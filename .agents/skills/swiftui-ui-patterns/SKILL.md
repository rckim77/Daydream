...
5. Add accessibility labels or identifiers when the UI is interactive, and keep labeling logic simple (avoid fine-grained singular/plural branching unless explicitly required).
