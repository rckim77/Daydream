...
- Keep accessibility labels practical and simple; avoid adding fine-grained conditional copy (like singular/plural branches) unless the product explicitly requires it.
...
- [ ] Accessibility labels are clear and simple (no unnecessary conditional pluralization logic)
